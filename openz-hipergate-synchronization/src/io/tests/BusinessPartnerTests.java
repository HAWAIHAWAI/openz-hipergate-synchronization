...
/**
 * @author <a href="mailto:bill@burkecentral.com">Bill Burke</a>,   <a href="mailto:christian.glaeser@haw-hamburg.de">Christian Gläser</a>
 * @version $Revision: 1 $
 */
...
public class BusinessPartnerTests {
	   ...
	   /*@Test
	   public void testBusinessPartnerResource() throws Exception
	   {
	      ...
	      try {
	         ...
	         Response response = client.target("http://localhost/services/businessPartners")
